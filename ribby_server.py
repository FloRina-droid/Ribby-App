...
SEED_SPECIES = os.getenv("RIBBY_SEED_SPECIES", "1").strip().lower() not in ("0", "false", "no", "nein")

DEFAULT_SPECIES = [
    {"id": "alytes-obstetricans", "name_de": "Geburtshelferkröte", "sci": "Alytes obstetricans", "category": "Amphibie"},
    {"id": "bufo-bufo", "name_de": "Erdkröte", "sci": "Bufo bufo", "category": "Amphibie"},
    {"id": "epidalea-calamita", "name_de": "Kreuzkröte", "sci": "Epidalea calamita", "category": "Amphibie"},
    {"id": "bufotes-viridis", "name_de": "Wechselkröte", "sci": "Bufotes viridis", "category": "Amphibie"},
    {"id": "pelobates-fuscus", "name_de": "Knoblauchkröte", "sci": "Pelobates fuscus", "category": "Amphibie"},
    {"id": "bombina-variegata", "name_de": "Gelbbauchunke", "sci": "Bombina variegata", "category": "Amphibie"},
    {"id": "bombina-bombina", "name_de": "Rotbauchunke", "sci": "Bombina bombina", "category": "Amphibie"},
    {"id": "hyla-arborea", "name_de": "Europäischer Laubfrosch", "sci": "Hyla arborea", "category": "Amphibie"},
    {"id": "rana-temporaria", "name_de": "Grasfrosch", "sci": "Rana temporaria", "category": "Amphibie"},
    {"id": "rana-arvalis", "name_de": "Moorfrosch", "sci": "Rana arvalis", "category": "Amphibie"},
    {"id": "rana-dalmatina", "name_de": "Springfrosch", "sci": "Rana dalmatina", "category": "Amphibie"},
    {"id": "pelophylax-esculentus", "name_de": "Teichfrosch", "sci": "Pelophylax esculentus", "category": "Amphibie"},
    {"id": "pelophylax-lessonae", "name_de": "Kleiner Wasserfrosch", "sci": "Pelophylax lessonae", "category": "Amphibie"},
    {"id": "pelophylax-ridibundus", "name_de": "Seefrosch", "sci": "Pelophylax ridibundus", "category": "Amphibie"},
    {"id": "salamandra-salamandra", "name_de": "Feuersalamander", "sci": "Salamandra salamandra", "category": "Amphibie"},
    {"id": "salamandra-atra", "name_de": "Alpensalamander", "sci": "Salamandra atra", "category": "Amphibie"},
    {"id": "ichthyosaura-alpestris", "name_de": "Bergmolch", "sci": "Ichthyosaura alpestris", "category": "Amphibie"},
    {"id": "lissotriton-helveticus", "name_de": "Fadenmolch", "sci": "Lissotriton helveticus", "category": "Amphibie"},
    {"id": "lissotriton-vulgaris", "name_de": "Teichmolch", "sci": "Lissotriton vulgaris", "category": "Amphibie"},
    {"id": "triturus-cristatus", "name_de": "Kammmolch", "sci": "Triturus cristatus", "category": "Amphibie"},
]
...
def seed_default_species():
    species_dir = DATA_DIR / "species"
    if not SEED_SPECIES or any(species_dir.glob("*.json")):
        return
    created_at = now_iso()
    for sp in DEFAULT_SPECIES:
        save_item(species_dir, {**sp, "img_url": None, "description": "", "created_at": created_at})
    print(f"  Standard-Artenliste angelegt: {len(DEFAULT_SPECIES)} Arten")
